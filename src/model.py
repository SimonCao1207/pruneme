...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.layer_reps = [1] * config.num_hidden_layers
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.config.virtual_layers and virtual:
            if self.config.double_virt:
                if self.config.num_hidden_layers == 8:
                    self.layer_reps = [2] * 8
                elif self.config.num_hidden_layers == 4:
                    self.layer_reps = [2] * 4
                else:
                    raise ValueError(
                ...
                if self.config.num_hidden_layers == 8:
                    self.layer_reps = [1, 1, 1, 1, 2, 3, 3, 4]
                elif self.config.num_hidden_layers == 4:
                    self.layer_reps = [1, 2, 2, 3]
                else:
                    raise ValueError(
                        f"Unsupported number of hidden layers {self.config.num_hidden_layers} for virtual layers."
                    )
